...
<!-- FAQ Section -->
<section class="faq-section modern-faq" id="faq">
    <div class="container">
        <h2 class="section-title reveal">ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ</h2>
        <div class="faq-content modern-layout">
            <div class="faq-list compact">
                <div class="faq-item enhanced">
                    ...
                    <div class="faq-answer">
                        <p>Минимальный заказ зависит от типа товара и способа доставки. Обычно от 1000$. Мы работаем как с крупными, так и с небольшими партиями.</p>
                    </div>
                </div>
                <div class="faq-item enhanced">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>Стоимость услуг рассчитывается индивидуально в зависимости от объема и сложности заказа. Используйте наш калькулятор для предварительного расчета.</p>
                    </div>
                </div>
                <div class="faq-item enhanced">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>Работаем по предоплате 50%, остаток после получения товара на складе в России. Принимаем оплату по безналичному расчету.</p>
                    </div>
                </div>
                <div class="faq-item enhanced">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>Заключаем официальный договор, предоставляем все необходимые документы и отчеты. Страхуем грузы и несем ответственность за сохранность.</p>
                    </div>
                </div>
                <div class="faq-item enhanced">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>Авиа: 5-10 дней, ЖД: 15-20 дней, Море: 30-45 дней. Сроки зависят от выбранного способа доставки и таможенного оформления.</p>
                    </div>
                </div>
                <div class="faq-item enhanced">
                    <div class="faq-question">
                        <span class="faq-icon">📦</span>
                        <span class="faq-text">Можно ли отследить посылку?</span>
                        <span class="faq-toggle">+</span>
                    </div>
                    <div class="faq-answer">
                        <p>Да, мы предоставляем полную отчетность и возможность отслеживания груза на всех этапах доставки через личный кабинет.</p>
                    </div>
                </div>
            </div>
            <div class="faq-image expanded">
                <div class="image-container">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/sections/pagoda.png" alt="Китайские товары и логистика" loading="lazy">
                    <div class="image-overlay">
                        <h3>КИТАЙСКИЕ ТОВАРЫ</h3>
