        ...
        'team' => array(
            array(
                ...
                'social_links' => array(
                    ...
                    array('name' => 'Email', 'url' => 'mailto:anna@atk-ved.ru', 'icon' => 'email')
                )
            ),
            array(
                ...
                'social_links' => array(
                    array('name' => 'LinkedIn', 'url' => '#', 'icon' => 'linkedin'),
                    array('name' => 'Email', 'url' => 'mailto:dmitry@atk-ved.ru', 'icon' => 'email')
                )
            ),
            array(
                'name' => 'Елена Петрова',
                ...
                'social_links' => array(
                    array('name' => 'LinkedIn', 'url' => '#', 'icon' => 'linkedin'),
                    array('name' => 'Email', 'url' => 'mailto:elena@atk-ved.ru', 'icon' => 'email')
                )
            )
        ),
        'statistics' => array(
